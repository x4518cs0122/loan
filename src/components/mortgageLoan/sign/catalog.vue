    ...
    <div class="catalog">
        <ul>
            ...
            <li v-for="(item, index) in list" :key="index" class="item-wrapper">
                ...
                <span @click="showDetail(item)" class="detail" v-html="item.checked !== 'hasClientInformation'&&item.checked !== 'has_client_information'? '查看明细':''">&nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></span>
            </li>
        </ul>
